...
with tf.Graph().as_default(), tf.compat.v1.Session() as sess:
    ...
    logs = open('DPED/models/' + phone + '.txt', "w+")
    logs.close()
    ...
    for i in range(num_train_iters):
        ...
        if i % eval_step == 0:
            ...
            logs = open('DPED/models/' + phone + '.txt', "a")
            ...
            for crop in enhanced_crops:
                ...
                # Save the image
                img.save('DPED/results/' + str(phone) + "_" + str(idx) + '_iteration_' + str(i) + '.jpg')
                idx += 1
            ...
            saver.save(sess, 'DPED/models/' + str(phone) + '_iteration_' + str(i) + '.ckpt', write_meta_graph=False)
